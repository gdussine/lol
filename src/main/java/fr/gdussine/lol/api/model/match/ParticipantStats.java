...
public class ParticipantStats {
	...
	private int perk0, perk0Var1, perk0Var2, perk0Var3;
	private int perk1, perk1Var1, perk1Var2, perk1Var3;
	private int perk2, perk2Var1, perk2Var2, perk2Var3;
	private int perk3, perk3Var1, perk3Var2, perk3Var3;
	private int perk4, perk4Var1, perk4Var2, perk4Var3;
	private int perk5, perk5Var1, perk5Var2, perk5Var3;
	private int statPerk0, statPerk1, statPerk2;
	private int perkPrimaryStyle, perkSubStyle;
	private int playerScore0, playerScore1, playerScore2, playerScore3, playerScore4, playerScore5, playerScore6,
			playerScore7, playerScore8, playerScore9;
	private int totalUnitsHealed, largestMultiKill, goldEarned, nodeNeutralizeAssist, totalPlayerScore, wardsKilled,
			pentaKills, champLevel, neutralMinionsKilled, deaths, tripleKills, largestCriticalStrike, nodeNeutralize,
			totalTimeCrowdControlDealt, totalScoreRank, nodeCapture, wardsPlaced, largestKillingSpree,
			neutralMinionsKilledTeamJungle, totalMinionsKilled, visionWardsBoughtInGame, objectivePlayerScore, kills,
			combatPlayerScore, inhibitorKills, turretKills, participantId, nodeCaptureAssist, assists, teamObjective,
			altarsNeutralized, goldSpent, altarsCaptured, longestTimeSpentLiving, killingSprees, sightWardsBoughtInGame,
			neutralMinionsKilledEnemyJungle, doubleKills, quadraKills;
	private boolean firstInhibitorKill, firstTowerKill, firstInhibitorAssist, firstTowerAssist, firstBloodAssist, win,
			unrealKills, firstBloodKill;
	private long physicalDamageTaken, damageDealtToObjectives, totalDamageTaken, magicDamageDealtToChampions,
			damageSelfMitigated, magicDamageDealt, totalDamageDealt, timeCCingOthers, magicalDamageTaken,
			totalDamageDealtToChampions, physicalDamageDealtToChampions, trueDamageTaken, damageDealtToTurrets,
			totalHeal, visionScore, physicalDamageDealt, trueDamageDealtToChampions, trueDamageDealt;
	...
	public void setGoldEarned(int goldEarded) {
		this.goldEarned = goldEarded;
	}
	...
	public boolean isUnrealKills() {
		return unrealKills;
	}

	public void setUnrealKills(boolean unrealKills) {
